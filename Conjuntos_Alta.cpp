...
{
	_Botones->setbothPos(189, 62);
	_Botones->settxtPos(196, 60);
	_Botones->setSize(26.0f, 26.0f);
	_Botones->setTextoString("...");
	_Botones->setBtnType(BTN_ADDCHAMP_CONJ);
...
void Conjuntos_Alta::dibujarEnVentana(sf::RenderWindow& _Ventana)
{
	...
	_Botones->dibujarBotoncito(_Ventana);
